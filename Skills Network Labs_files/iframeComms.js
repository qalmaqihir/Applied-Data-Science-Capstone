      ...
      switch (type) {
        case "frame_loaded":
          ...
          if (window.theia_frame) {
            ...
            window.theia_frame.postMessage({ type: "update_theme", color: localStorage.getItem("currentTheme") }, window.theia_origin);
      ...
      switch (type) {
        case "frame_loaded":
          ...
          if (window.author_ide_frame) {
            ...
            window.author_ide_frame.postMessage({ type: "update_theme", color: localStorage.getItem("currentTheme") }, window.author_ide_origin);
            window.removeEventListener('message', listenerFunction)
          };
          break;
      }
